...
my @param = (
   ...
   ["NV_WCN"        , ${ARGV[$index+3]}  , 1        , 1        , 0        , 0x80000008, 0xFFFFFFFF  ],
   ["PhaseCheck"    , ""                 , 0        , 1        , 0        , 0x80000014, 0xFFFFFFFF  ],
   ["ProdNV"        , ${ARGV[$index+4]}  , 1        , 1        , 0        , 0x0       , 0xFFFFFFFF  ],
   ["EraseUBOOT"    , ""                 , 0        , 1        , 0        , 0x0       , 0xFFFFFFFF  ],
   ["SPLLoader"     , ${ARGV[$index+5]}  , 1        , 1        , 0        , 0x0       , 0xFFFFFFFF  ],
   ["Modem_W"       , ${ARGV[$index+6]}  , 1        , 1        , 0        , 0x0       , 0xFFFFFFFF  ],
   ["DSP_W"         , ${ARGV[$index+7]}  , 1        , 1        , 0        , 0x0       , 0xFFFFFFFF  ],
   ["Modem_WCN"     , ${ARGV[$index+8]}  , 1        , 1        , 0        , 0x0       , 0xFFFFFFFF  ],
   ["BOOT"          , ${ARGV[$index+9]}  , 1        , 1        , 0        , 0x0       , 0xFFFFFFFF  ],
   ["Recovery"      , ${ARGV[$index+10]} , 1        , 1        , 0        , 0x0       , 0xFFFFFFFF  ],
